...
public   interface  CIMConstant  {
   ...
   public static interface IntentAction{
	...
	// 消息广播action
	String ACTION_MESSAGE_RECEIVED = "com.farsunset.lvxin.MESSAGE_RECEIVED";
	
	// 发送sendbody失败广播
	String ACTION_SENT_FAILED = "com.farsunset.lvxin.SENT_FAILED";
	
	// 发送sendbody成功广播
	String ACTION_SENT_SUCCESSED = "com.farsunset.lvxin.SENT_SUCCESSED";
	
	// 链接意外关闭广播
	String ACTION_CONNECTION_CLOSED = "com.farsunset.lvxin.CONNECTION_CLOSED";
	
	// 链接失败广播
	String ACTION_CONNECTION_FAILED = "com.farsunset.lvxin.CONNECTION_FAILED";
	
	// 链接成功广播
	String ACTION_CONNECTION_SUCCESSED = "com.farsunset.lvxin.CONNECTION_SUCCESSED";
	
	// 发送sendbody成功后获得replaybody回应广播
	String ACTION_REPLY_RECEIVED = "com.farsunset.lvxin.REPLY_RECEIVED";
	
	// 网络变化广播
	String ACTION_NETWORK_CHANGED = "android.net.conn.CONNECTIVITY_CHANGE";
	
	//重试连接
	String ACTION_CONNECTION_RECOVERY = "com.farsunset.lvxin.CONNECTION_RECOVERY";
  }
