...
public class GroupMessagePusher extends CIMMessagePusher {
	...
	public void push(final Message msg) {
		...
		List<String> memberList = groupMemberRepository.getMemberAccountList(Long.valueOf(groupId));
	...
	public void pushEvent(final Message msg) {
		...
		List<String> memberList = groupMemberRepository.getMemberAccountList(Long.valueOf(msg.getSender()));
		List<Message> messageList = new ArrayList<Message>();
