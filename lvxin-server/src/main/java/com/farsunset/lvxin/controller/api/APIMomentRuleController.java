...
public class APIMomentRuleController {
	...
	public BaseResult list(@TokenAccount String account) {
		...
		result.dataList = momentRuleServiceImpl.queryList(account);
		return result;
	}

	@RequestMapping(value = "/save.api")
	public BaseResult save(MomentRule momentRule,@TokenAccount String account) throws IOException {
		BaseResult result = new BaseResult();
		momentRule.setAccount(account);
		momentRuleServiceImpl.save(momentRule);
		return result;
	}
	...
	public BaseResult delete(MomentRule momentRule,@TokenAccount String account) {
		BaseResult result = new BaseResult();
		momentRule.setAccount(account);
		momentRuleServiceImpl.delete(momentRule);
		return result;
	}
