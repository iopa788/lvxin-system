...
public class APIConfigController {
	...
	public BaseResult list(String domain) {
		...
		result.dataList = configServiceImpl.queryListByDomain(domain);
		return result;
	}

	@RequestMapping(value = "/save.api")
	public BaseResult save(Config config) throws IOException {
		BaseResult result = new BaseResult();
	...
	public BaseResult get(Config config) {
		...
		result.data = configServiceImpl.querySingle(config);
		return result;
	}
	...
	public BaseResult delete(String gid) {
		...
		configServiceImpl.delete(gid);
		return result;
	}

	@RequestMapping(value = "/getNewVersion.api")
	public BaseResult getNewVersion(String domain, int versionCode) throws IOException {
		BaseResult result = new BaseResult();
		Map<String, String> map = configServiceImpl.queryMapByDomain(domain);
