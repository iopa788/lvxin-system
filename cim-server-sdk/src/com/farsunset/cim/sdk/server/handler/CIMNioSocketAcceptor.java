...
public class CIMNioSocketAcceptor extends IoHandlerAdapter implements KeepAliveMessageFactory{
	...
	private Logger logger = Logger.getLogger(CIMNioSocketAcceptor.class.getName());
	...
	public void sessionCreated(IoSession session) {
		logger.info("sessionCreated()... from "+session.getRemoteAddress()+" nid:" + session.getId());
	}
	...
	public void sessionClosed(IoSession session) {
		...
		logger.warning("sessionClosed()... from "+session.getRemoteAddress()+" nid:"+cimSession.getNid() +",isConnected:"+session.isConnected());
	...
	public void sessionIdle(IoSession session, IdleStatus status)  {
		logger.info("sessionIdle()... from "+session.getRemoteAddress()+" nid:" + session.getId());
	}
	...
	public void exceptionCaught(IoSession session, Throwable cause){
		...
		logger.warning("exceptionCaught()... from "+session.getRemoteAddress()+" isConnected:"+session.isConnected()+" nid:" + session.getId());
		session.closeNow();
	}
	...
	public void addHandler(String key,CIMRequestHandler handler) {
