...
public class UtilityAdapter {
    ...
    public static boolean captureThumbnails(String videoPath, String outputPath) {
        ...
        String ss = " -ss " + 1;
        String cmd = String.format("ffmpeg -i \"%s\"%s  -vframes 1 \"%s\"", videoPath, ss, outputPath);
