...
public abstract class MediaRecorderBase implements Callback, PreviewCallback, IMediaRecorder {
    ...
    public boolean toggleFlashMode() {
        if (mParameters != null) {
            try {
                ...
                MLog.e("Yixia", "toggleFlashMode", e);
            }
        }
        return false;
    }
    ...
    public void startPreview() {
        ...
        try {
            ...
            MLog.e("Yixia", "startPreview fail :" + e.getMessage());
        }
    }
    ...
    protected void setPreviewCallback() {
        ...
        if (size != null) {
            ...
            try {
                ...
                MLog.e("Yixia", "startPreview...setPreviewCallback...", e);
            }
            MLog.e("Yixia", "startPreview...setPreviewCallbackWithBuffer...width:" + size.width + " height:" + size.height);
        } else {
    ...
    public void testPreviewFrameCallCount() {
        new CountDownTimer(1 * 60 * 1000, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                MLog.e("[Vitamio Recorder]", "testFrameRate..." + mPreviewFrameCallCount);
    ...
    protected void concatVideoParts() {
        new AsyncTask<Void, Void, Boolean>() {
            ...
            protected Boolean doInBackground(Void... params) {
                //合并ts流
                String cmd = String.format("ffmpeg -i \"%s\" -vcodec copy  -acodec copy -absf aac_adtstoasc -f mp4 -movflags faststart \"%s\"", mMediaObject.getConcatYUV(), mMediaObject.getOutputVideoPath());
                int i = UtilityAdapter.FFmpegRun("", cmd);
                if (mode == 0) {
                    File srcMp4 = new File(mMediaObject.getOutputVideoPath());
                    File desMp4 = new File(srcMp4.getParentFile(), System.currentTimeMillis() + "_trans.mp4");
                    cmd = String.format("ffmpeg -i \"%s\" -vf \"transpose=2\" \"%s\"", srcMp4.getAbsolutePath(), desMp4.getAbsolutePath());
                    i = UtilityAdapter.FFmpegRun("", cmd);
                    srcMp4.delete();
                    desMp4.renameTo(srcMp4);
                }
                UtilityAdapter.captureThumbnails(mMediaObject.getOutputVideoPath(), mMediaObject.getOutputVideoThumbPath());
                return i == 0;
            }
