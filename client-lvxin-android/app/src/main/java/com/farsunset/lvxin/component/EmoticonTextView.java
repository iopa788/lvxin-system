...
public class EmoticonTextView extends android.support.v7.widget.AppCompatTextView {
    protected int faceSize = 16;
    ...
    public Spannable getEmotionSpaned(CharSequence text) {
