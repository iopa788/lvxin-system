...
public class PermissionCompat {
    ...
    public static boolean checkSelfPermission(@NonNull Context context, @NonNull String permission) {
        if (getTargetVersionCode(context) >= Build.VERSION_CODES.M) {
    ...
    public static boolean checkPermissionForeverDenied(@NonNull AppCompatActivity context, @NonNull String permission) {
