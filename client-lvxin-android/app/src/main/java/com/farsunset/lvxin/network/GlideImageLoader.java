...
public class GlideImageLoader implements CloudImageLoader {
    ...
    public void loadAndApply(ImageView target, String url, Drawable defDrawable, float round, final CloudImageApplyListener listener) {
        ...
        RequestBuilder request = Glide.with(LvxinApplication.getInstance()).asBitmap().load(url);
    ...
    public static class GlideCircleTransform extends BitmapTransformation {
        ...
        public GlideCircleTransform(float rounded) {
