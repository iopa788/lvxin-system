...
public interface PublicMenuService {
	...
	void update(PublicMenu menu);

	List<PublicMenu> queryList(String paccount);

	PublicMenu queryById(String gid);

	void add(PublicMenu menu);

	void delete(PublicMenu publicMenu);
