...
public class Message implements Serializable {
	public transient static final String TABLE_NAME = "t_lvxin_message";
	private transient static final long serialVersionUID = 1845362556725768545L;

	public transient static final String STATUS_NOT_RECEIVED = "0";// 未接受
	public transient static final String STATUS_RECEIVED = "1";// 已接收
	public transient static final String STATUS_READ = "2";// 已读取

	public transient static final String ACTION_0 = "0";
	public transient static final String ACTION_1 = "1";
	public transient static final String ACTION_2 = "2";
	public transient static final String ACTION_3 = "3";
