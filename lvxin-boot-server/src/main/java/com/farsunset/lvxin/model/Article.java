...
public class Article implements Serializable {
	...
	public transient final static String FORMAT_TEXT_IMAGE = "0";// 图文
	public transient final static String FORMAT_LINK = "1";// 网址连接
	public transient final static String FORMAT_VIDEO = "2";// 视频
